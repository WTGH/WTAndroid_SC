package com.wetrain.client.customviews.dotprogressbar;
...
public class DottedProgressBar extends View {
    ...
    public DottedProgressBar(Context context, AttributeSet attrs) {
        ...
        try {
           // mEmptyDotsColor = a.getColor(R.styleable.DottedProgressBar_emptyDotsColor, Color.BLACK);
           // mActiveDotColor = a.getColor(R.styleable.DottedProgressBar_activeDotColor, Color.GREEN);
